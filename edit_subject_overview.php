...
<?php $subject_id = $_GET['subject_id']; ?>
    <body>
           ...
           'subject_code'
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
								...
								<a href="subject_overview.php<?php echo '?id=' .
        ...
        ($subject_query = mysqli_query(
            $conn,
            "select * from class_subject_overview where  class_subject_overview_id  = '$subject_id'"
        )) or die(mysqli_error());
        ...
        ?>
														<form class="form-horizontal" method="post">
																<div class="control-group">
																	...
																	<div class="controls">
																			<textarea name="content" id="ckeditor_full"><?php echo $subject_row[
                       'content'
                   ]; ?></textarea>
																	</div>
																</div>
              ...
              mysqli_query(
                  $conn,
                  "update class_subject_overview set content = '$content' where class_subject_overview_id = '$subject_id'"
              ) or die(mysqli_error());
              ?>
										<script>

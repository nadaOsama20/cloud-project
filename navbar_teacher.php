	<div class="navbar navbar-fixed-top navbar-inverse">
           <div class="navbar-inner">
               <div class="container-fluid">
                   ...
                   <a class="brand" href="#">Welcome Advisor</a>
							<div class="nav-collapse collapse">
								<ul class="nav pull-right">
												<?php
            ($query = mysqli_query(
                $conn,
                "select * from teacher where teacher_id = '$session_id'"
            )) or die(mysqli_error());
            $row = mysqli_fetch_array($query);
            ?>
												<li class="dropdown">
													<a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-user icon-large"></i><?php echo $row[
                 'firstname'
             ] .
                 ' ' .
                 $row['lastname']; ?> <i class="caret"></i></a>

...
<?php $get_id = $_GET['id']; ?>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<div class="pull-right">
							<a href="my_students.php<?php echo '?id=' .
           $get_id; ?>" class="btn btn-info"><i class="icon-arrow-left"></i> Back</a>
						</div>
										<?php
                        ...
                        <div id="block_bg" class="block">
						 ...
						 <thead>
                            ...
                            <tbody>
                                         ...
                                         ($query = mysqli_query(
                                             $conn,
                                             "select * from student LEFT JOIN class on class.class_id = student.class_id
                                        ...
                                        <td width="70"><img  class="img-rounded" src="admin/<?php echo $row[
                                            'location'
	...
	<?php if (isset($_POST['submit'])) {
     ...
     for ($b = 1; $b <= $test; $b++) {
         ...
         ($query = mysqli_query(
             $conn,
             "select * from teacher_class_student where student_id = '$id' and teacher_class_id = '$class_id' "
         )) or die(mysqli_error());
	...
	<?php } elseif ($Add == 'Add') {
             mysqli_query(
                 $conn,
                 "insert into teacher_class_student (student_id,teacher_class_id,teacher_id) values('$id','$class_id','$teacher_id') "
             ) or die(mysqli_error());
         } else {
         }
         ?>

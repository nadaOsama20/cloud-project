           ...
           'school_year'
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                ...
                                ($query = mysqli_query(
                                    $conn,
                                    "select * FROM assignment where class_id = '$get_id' and teacher_id = '$session_id' order by fdatein DESC "
                                )) or die(mysqli_error());
								...
								<tr>
                                         ...
                                         <td width="150">
										  <form method="post" action="view_submit_assignment.php<?php echo '?id=' .
               ...
               ?>
										 <a data-placement="bottom" title="Download" id="<?php echo $id; ?>download"  class="btn btn-info" href="<?php echo $row[
    'floc'
]; ?>"><i class="icon-download icon-large"></i></a>
										<?php
          } ?>

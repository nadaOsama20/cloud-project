            ...
            <div class="row-fluid">
                            ...
                            <div class="block-content collapse in">
								...
								<form action="delete_sy.php" method="post">
									...
									<?php include 'modal_delete.php'; ?>
										...
										<tbody>
													<?php
             ($user_query = mysqli_query($conn, 'select * from school_year')) or
                 die(mysqli_error());
             while ($row = mysqli_fetch_array($user_query)) {
                 $id = $row['school_year_id']; ?>
												...
												<td width="40">
												<a href="edit_user.php<?php echo '?id=' .
                $id; ?>"  data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large"></i></a>
												</td>

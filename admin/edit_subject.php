...
<?php $get_id = $_GET['id']; ?>
    <body>
        ...
        <div class="container-fluid">
         ...
         ($query = mysqli_query(
             $conn,
             "select * from subject where subject_id = '$get_id'"
         )) or die(mysqli_error());
         ...
         ?>
               ...
               'subject_code'
										...
										<div class="control-group">
											...
											<input type="text" value="<?php echo $row[
               'subject_title'
           ]; ?>" class="span8" name="title" id="inputPassword" placeholder="Subject Title" required>
											</div>
										</div>
										<div class="control-group">
											...
											<input type="text" value="<?php echo $row[
               'unit'
           ]; ?>" class="span1" name="unit" id="inputPassword" required>
											</div>
										</div>
										<div class="control-group">
              ...
              mysqli_query(
                  $conn,
                  "update subject set subject_code = '$subject_code' ,
																		subject_title = '$title',
																		unit  = '$unit',
              ...
              mysqli_query(
                  $conn,
                  "insert into activity_log (date,username,action) values(NOW(),'$user_username','Edit Subject $subject_code')"
              ) or die(mysqli_error());
              ?>
										<script>

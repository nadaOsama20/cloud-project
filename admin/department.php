                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<?php include 'modal_delete.php'; ?>
										...
										<tbody>
													<?php
             ($user_query = mysqli_query($conn, 'select * from department')) or
                 die(mysqli_error());
             while ($row = mysqli_fetch_array($user_query)) {
                 $id = $row['department_id']; ?>
													...
													<tr>
														...
														<td width="30"><a href="edit_department.php<?php echo '?id=' .
                  $id; ?>" class="btn btn-success"><i class="icon-pencil icon-large"></i></a></td>

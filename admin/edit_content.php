...
<?php $get_id = $_GET['id']; ?>
    <body>
        ...
        <div class="container-fluid">
            ...
            ($query = mysqli_query(
                $conn,
                "select * from content where content_id = '$get_id'"
            )) or die(mysqli_error());
            ...
            ?>
									   ...
									   <form class="form-horizontal" method="POST">
										...
										<div class="controls">
										<input type="text" name="title" id="inputEmail" placeholder="Title" value="<?php echo $row[
              'title'
          ]; ?>">
										</div>
										</div>
              ...
              mysqli_query(
                  $conn,
                  "update content set title = '$title' , content = '$content' where content_id = '$get_id'"
              ) or die(mysqli_error());
              ?>
										<script>

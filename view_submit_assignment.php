...
?>
    ...
    <body id="studentTableDiv">
        ...
        <div class="container-fluid">
           ...
           'school_year'
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-right"><a href="assignment.php<?php echo '?id=' .
                                    $get_id; ?>"><i class="icon-arrow-left"></i> Back</a></div>
                            </div>
         ...
         ($query1 = mysqli_query(
             $conn,
             "select * FROM assignment where assignment_id = '$post_id'"
         )) or die(mysqli_error());
         $row1 = mysqli_fetch_array($query1);
         ?>
									<div class="alert alert-info">Submit Assignment in : <?php echo $row1[
             'fname'
         ]; ?></div>
                                    ...
                                    $id =
										...
										<tr>
                                         ...
                                         <td><a href="<?php echo $row[
                                             'floc'
                                         ]; ?>"><i class="icon-download icon-large"></i></a></td>                                                                        
                                         <td width="140">
										 ...
										 <input type="text" class="span4" name="grade" value="<?php echo $row[
               'grade'
           ]; ?>">
